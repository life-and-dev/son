---
description: An examination of biblical language and passages commonly discussed in relation to the Trinity.
keywords: Trinity, Godhead, Shema, elohim, biblical language, Trinitarian theology
---
...
The term ["Godhead"](godhead.md) in the KJV is often quoted to prove the presence of the Trinity in the Bible. However, the word means deity or divine nature. It does not, by itself, mean the Trinity or establish three divine persons.

The KJV uses "Godhead" in Acts 17:29, Romans 1:20, and Colossians 2:9. Other [translations](https://word.ofgod.info/translations) use different wording rather than one identical expression. For example, Acts 17:29 is commonly rendered "divine being", Romans 1:20 "divine nature", and Colossians 2:9 "deity". Many popular translations therefore do not use the word "Godhead".

## The "Unified" God

The [Shema](../shema.md) states there is only **one** God (Deuteronomy 6:4-5), however the Trinitarian theology descibe:

1. the Father is God,
2. the Son is God,
3. the Spirit is God.

The same Hebrew and Greek words for "one" could also mean "only", "alone", "single" or even "united" depending on the context or interpretation, therefore Trinitarians argue that "God is one" actually means "God is unified" or that the [Godhead](godhead.md) is the "only" God.
...
If the intended was to communicate a composite Godhead, then the pronouns would have been plural instead of **singular**.

Another challenge is how man could be created in a single "image" (Genesis 1:27). If God consisted of three distinct personalities, it implies Adam would have been created with a similar plural nature to reflect that image.

This begs the question who are the "us" and "our" in Genesis 1:26 if it is not the Trinity because Isaiah wrote:
...
[Trinitarians](../trinity.md) reason that members within [the Godhead](godhead.md) were having a meeting. However, the next verses read:
...
The article considers whether [the Godhead](#the-godhead), [plural language](#god-doing-divine-things-in-partnership), and [Paul's closing](#pauls-closing) establish Trinitarian claims. It concludes that these claims warrant careful scrutiny and may be read without requiring a Trinitarian framework.
